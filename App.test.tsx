...
expect(getByTestId("resultText")).toHaveTextContent("Result: 25");
});
...
fireEvent.press(getByTestId("addButton"));
expect(getByTestId("resultText")).toHaveTextContent("Result: 5");
});
...
fireEvent.press(getByTestId("addButton"));
expect(getByTestId("resultText")).toHaveTextContent("Result: -3");
});
...
fireEvent.press(getByTestId("addButton"));
expect(getByTestId("resultText")).toHaveTextContent("Result: 6");
});
test("clears all fields and resets the result", () => {
const { getByTestId } = render(<App />);

fireEvent.changeText(getByTestId("input1"), "20");
fireEvent.changeText(getByTestId("input2"), "30");
fireEvent.press(getByTestId("addButton"));
expect(getByTestId("resultText")).toHaveTextContent("Result: 50");
...
expect(getByTestId("resultText")).toHaveTextContent("Result:");
expect(getByTestId("resultText")).not.toHaveTextContent("50");
});
});